...
This file is included at the top of the display_commercial.php file above all of the photographs that don't belong to a photoset.
...
$sql= "SELECT id, title, cover_photo, display_hide FROM photo_sets WHERE category = 'Commercial' AND display_hide = 0 ORDER BY id";
