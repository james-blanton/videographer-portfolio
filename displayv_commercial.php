...
If the user clicks on the "COMMERCIAL" tab while on video.php, then this file will be displayed on the page.
This particular tab will display all of the videos that have been entered in to the database with the category of "Commercial"
...
// Select statement to get all of the data on every commercial video in the database that does not have a a boolean flag for display_hide set to 1
$sql= "SELECT id, description, filename, fileextension, display_hide FROM video WHERE category = 'Commercial' AND display_hide = 0 ORDER BY id";
